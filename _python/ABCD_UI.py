...
class Ui_Demo(object):
    def setupUi(self, Demo):
        ...
        self.Upper_Bay_Label.setGeometry(QtCore.QRect(580, 190, 111, 21))
        ...
        self.Lower_Bay_Label.setGeometry(QtCore.QRect(580, 390, 111, 21))
    ...
    def retranslateUi(self, Demo):
        ...
        self.Test_Capture.setText(_translate("Demo", "PushButton"))
